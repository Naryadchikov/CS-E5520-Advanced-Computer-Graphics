...
namespace FW
{
    ...
    protected:
        ...
        Vec4f computeShadingAmbientOcclusion(RayTracer* rt, const RaycastResult& hit, const CameraControls& cameraCtrl,
                                             Random& rnd);

        // EXTRA: implement the whitted integrator extra
        Vec4f computeShadingWhitted(RayTracer* rt, const RaycastResult& hit, const CameraControls& cameraCtrl,
