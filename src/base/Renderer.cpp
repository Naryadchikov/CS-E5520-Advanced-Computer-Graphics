...
namespace FW
{
    ...
    timingResult Renderer::rayTracePicture(RayTracer* rt, Image* image, const CameraControls& cameraCtrl,
                                           ShadingMode mode)
    {
...
#pragma omp parallel for
        ...
        result.duration = (int)((stop.QuadPart - start.QuadPart) * 1000.0 / frequency.QuadPart);
    ...
    Vec4f Renderer::computeShadingHeadlight(const RaycastResult& hit, const CameraControls& cameraCtrl)
    {
        ...
        // specular color. Not used in requirements, but you can use this in extras if you wish.
