...
namespace FW
{
    ...
    private:
        ...
        RaycastResult intersectNode(const Vec3f& orig, const Vec3f& dir, const BvhNode& node, float tMin) const;

        bool isIntersectedWithBB(const Vec3f& orig, const Vec3f& dir, const AABB& bb, float tMin) const;
